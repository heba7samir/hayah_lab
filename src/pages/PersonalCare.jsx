...
export const PersonalCare = () => {
     const personalProducts = products.filter((product) =>
         product.categories.includes("personal-care")
     );
 
    return (
         <div className="main_section flex flex-col gap-12">
            <h2 className='text-2xl md:text-4xl font-bold font-barlow pl-8 pt-8'>Personal Care</h2>
